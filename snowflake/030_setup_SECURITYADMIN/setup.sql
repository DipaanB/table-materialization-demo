...
GRANT USAGE ON DATABASE STITCH_DB                         TO ROLE DATAMEER_SERVICE_ROLE;
GRANT USAGE ON SCHEMA STITCH_DB.STAGE_2                   TO ROLE DATAMEER_SERVICE_ROLE;
GRANT SELECT ON ALL TABLES IN SCHEMA STITCH_DB.STAGE_2    TO ROLE DATAMEER_SERVICE_ROLE;
GRANT SELECT ON FUTURE TABLES IN SCHEMA STITCH_DB.STAGE_2 TO ROLE DATAMEER_SERVICE_ROLE;

GRANT CREATE TABLE ON SCHEMA STITCH_DB.DATAMEER           TO ROLE DATAMEER_SERVICE_ROLE;
GRANT CREATE STAGE ON SCHEMA STITCH_DB.DATAMEER           TO ROLE DATAMEER_SERVICE_ROLE;
GRANT CREATE FILE FORMAT ON SCHEMA STITCH_DB.DATAMEER     TO ROLE DATAMEER_SERVICE_ROLE;
GRANT CREATE TASK ON SCHEMA STITCH_DB.DATAMEER            TO ROLE DATAMEER_SERVICE_ROLE;
GRANT USAGE, OPERATE ON WAREHOUSE COMPUTE_WH              TO ROLE DATAMEER_SERVICE_ROLE;
