...
CREATE OR REPLACE PROCEDURE "REGION_EU_0615_2225"()
RETURNS VARCHAR
LANGUAGE SQL
...
BEGIN
  ...
  FROM (
    SELECT EXISTS (
      ...
      WHERE
        ...
        AND table_name = 'REGION_EU_0615_2225'
    ) AS table_exists_field
  );

  -- materialize: create staging table
  CREATE OR REPLACE TABLE "REGION_EU_0615_2225_STAGING_20220616_022604" COMMENT="CREATED-BY-DATAMEER/ga11530merge/v1" AS
  ...
  IF (table_exists) THEN
    ...
    ALTER TABLE "REGION_EU_0615_2225"
    SWAP WITH "REGION_EU_0615_2225_STAGING_20220616_022604";
    -- drop staging table
    DROP TABLE "REGION_EU_0615_2225_STAGING_20220616_022604";
  ELSE
    -- rename staging table ...
    ALTER TABLE "REGION_EU_0615_2225_STAGING_20220616_022604"
    RENAME TO "REGION_EU_0615_2225";
  END IF;
END;
$$;
...
END;
$$;
ALTER TASK IF EXISTS "REGION_EU_0615_2225" SUSPEND;
DROP TASK IF EXISTS "REGION_EU_0615_2225";
