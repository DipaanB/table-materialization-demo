...
BEGIN
  ...
  CREATE OR REPLACE TABLE "REGION_EU_0615_2225_STAGING_20220616_022734" COMMENT="CREATED-BY-DATAMEER/ga11530merge/v1" AS
  ...
  IF (table_exists) THEN
    ...
    SWAP WITH "REGION_EU_0615_2225_STAGING_20220616_022734";
    -- drop staging table
    DROP TABLE "REGION_EU_0615_2225_STAGING_20220616_022734";
  ELSE
    -- rename staging table ...
    ALTER TABLE "REGION_EU_0615_2225_STAGING_20220616_022734"
